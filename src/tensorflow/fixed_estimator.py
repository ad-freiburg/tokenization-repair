# ==============================================================================
# Copy of estimator.py in TensorFlow 1.12,
# where a bug with the training_hooks is fixed.
#
# The bug was reported and the fix proposed here: https://github.com/tensorflow/tensorflow/issues/23508
# ==============================================================================
